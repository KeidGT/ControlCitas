...
hora_inic_even TIME NOT NULL,
hora_fina_even TIME NOT NULL
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
hora_camb_cita TIME NOT NULL, -- Hora de cuando se realizo el registro (cambio)
fech_inic_cita_nuev DATE NOT NULL, -- Nueva fecha inicio registrada que se aplicará al registro (fecha cita)
hora_inic_cita_nuev TIME NOT NULL, -- Nueva hora inicio registrada que se aplicará al registro (hora cita)
fech_fin_cita_nuev DATE NOT NULL, -- Nueva fecha fin registrada que se aplicará al registro (fecha cita)
hora_fin_cita_nuev TIME NOT NULL, -- Nueva hora fin registrada que se aplicará al registro (hora cita)
...
hora_inic_hora_disp TIME NOT NULL, -- Hora Inicio 
hora_fina_hora_disp TIME NOT NULL, --  Hora Fin
